...
public class LibVLC extends VLCObject<ILibVLC.Event> implements ILibVLC {
    ...
    /**
     * LibVLC passes this as the HTTP Referer string
     * when a protocol requires it.
     *
     * @param http HTTP Referer, e.g. "www.example.com"
     */
    public void setHttpReferer(String referer){
        nativeSetHttpReferer(referer);
    }
    private native void nativeSetHttpReferer(String referer);
